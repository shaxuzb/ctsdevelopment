    ...
    <section className='project_choose_house'>
      ...
      <div className="proj_home_parent">
        ...
        <div className="containerAboutProj">
          <AboutProj header_text_h1_proj={t('Project.swipe_proj_header')} header_text_parag_proj={t('Project.swipe_proj_parag')} image_proj_about={asset.aboutuslinkimg} addres_proj={'г. Олмалык, ул. Абдулла Каххара 30, проект “Yangi O’zbekiston”'} deadline_proj={"Декабрь 2024-года"} inform_about_proj={fetchDataProj} />
        </div>
    </section>
  )
}
